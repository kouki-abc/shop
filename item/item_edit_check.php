...
if($item_name=='' || preg_match('/\A[0-9]+\z/',$item_price)==0 || $item_image['size']>1000000)
{
  print '<form>';
...
else
{
  ...
  print '<input type="hidden" name="code" value="'.$item_code.'">';
  ...
  print '<input type="hidden" name="image_name_old" value="'.$item_image_name_old.'">';
